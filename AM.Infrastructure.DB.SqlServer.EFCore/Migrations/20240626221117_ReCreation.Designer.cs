...
namespace AM.Infrastructure.DB.SqlServer.EFCore.Migrations
{
    ...
    [Migration("20240626221117_ReCreation")]
            ...
            modelBuilder.Entity("AM.Domain.Core.AccountAgg.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationDate = new DateTime(2024, 6, 26, 15, 11, 14, 337, DateTimeKind.Local).AddTicks(3649),
                            Fullname = "Mary",
                            IsRemoved = false,
                            Mobile = "09386485663",
            ...
            modelBuilder.Entity("AM.Domain.Core.RoleAgg.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationDate = new DateTime(2024, 6, 26, 15, 11, 14, 338, DateTimeKind.Local).AddTicks(1308),
                            IsRemoved = false,
                            Name = "مدیرسیستم"
                        },
                        new
                        {
                            Id = 2L,
                            CreationDate = new DateTime(2024, 6, 26, 15, 11, 14, 338, DateTimeKind.Local).AddTicks(1429),
                            IsRemoved = false,
                            Name = "کاربر عادی"
                        },
                        new
                        {
                            Id = 3L,
                            CreationDate = new DateTime(2024, 6, 26, 15, 11, 14, 338, DateTimeKind.Local).AddTicks(1448),
                            IsRemoved = false,
                            Name = "محتوا گذار"
                        },
                        new
                        {
                            Id = 4L,
                            CreationDate = new DateTime(2024, 6, 26, 15, 11, 14, 338, DateTimeKind.Local).AddTicks(1465),
                            IsRemoved = false,
                            Name = "کاربر همکار"
                        });
                });

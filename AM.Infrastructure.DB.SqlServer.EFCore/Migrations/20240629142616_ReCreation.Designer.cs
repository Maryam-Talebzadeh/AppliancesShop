...
namespace AM.Infrastructure.DB.SqlServer.EFCore.Migrations
{
    ...
    [Migration("20240629142616_ReCreation")]
            ...
            modelBuilder.Entity("AM.Domain.Core.AccountAgg.Entities.Account", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationDate = new DateTime(2024, 6, 29, 7, 26, 13, 593, DateTimeKind.Local).AddTicks(2672),
                            Fullname = "Mary",
                            IsRemoved = false,
                            Mobile = "09386485663",
            ...
            modelBuilder.Entity("AM.Domain.Core.RoleAgg.Entities.Role", b =>
                {
                    ...
                    b.HasData(
                        ...
                        {
                            Id = 1L,
                            CreationDate = new DateTime(2024, 6, 29, 7, 26, 13, 593, DateTimeKind.Local).AddTicks(9517),
                            IsRemoved = false,
                            Name = "مدیرسیستم"
                        },
                        new
                        {
                            Id = 2L,
                            CreationDate = new DateTime(2024, 6, 29, 7, 26, 13, 593, DateTimeKind.Local).AddTicks(9645),
                            IsRemoved = false,
                            Name = "کاربر عادی"
                        },
                        new
                        {
                            Id = 3L,
                            CreationDate = new DateTime(2024, 6, 29, 7, 26, 13, 593, DateTimeKind.Local).AddTicks(9664),
                            IsRemoved = false,
                            Name = "محتوا گذار"
                        },
                        new
                        {
                            Id = 4L,
                            CreationDate = new DateTime(2024, 6, 29, 7, 26, 13, 593, DateTimeKind.Local).AddTicks(9679),
                            IsRemoved = false,
                            Name = "کاربر همکار"
                        });
                });
